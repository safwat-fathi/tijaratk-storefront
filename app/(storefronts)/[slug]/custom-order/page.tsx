		...
		return (
			<div className="max-w-2xl mx-auto px-4 py-16 text-center">
				...
				<p className="text-gray-600 mb-8">
					We have received your custom order request. The seller will review it
					and send you a quote soon.
				</p>
				<Link
					href={`/${slug}`}
	...
	return (
		<div className="max-w-2xl mx-auto px-4 py-10 sm:px-6">
			...
			<p className="text-gray-500 mb-8">
				Can&apos;t find what you&apos;re looking for? Describe it below and
				we&apos;ll create it just for you.
			</p>
